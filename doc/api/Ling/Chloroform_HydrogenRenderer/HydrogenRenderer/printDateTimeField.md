...
HydrogenRenderer::printDateTimeField
================



HydrogenRenderer::printDateTimeField — Prints the given datetime field.
...
public [HydrogenRenderer::printDateTimeField](https://github.com/lingtalfi/Chloroform_HydrogenRenderer/blob/master/doc/api/Ling/Chloroform_HydrogenRenderer/HydrogenRenderer/printDateTimeField.md)(array $field) : void
...
Source Code
===========
See the source code for method [HydrogenRenderer::printDateTimeField](https://github.com/lingtalfi/Chloroform_HydrogenRenderer/blob/master/HydrogenRenderer.php#L530-L588)
