...
HydrogenRenderer::printFileField
================



HydrogenRenderer::printFileField — Prints the given file field.
...
public [HydrogenRenderer::printFileField](https://github.com/lingtalfi/Chloroform_HydrogenRenderer/blob/master/doc/api/Ling/Chloroform_HydrogenRenderer/HydrogenRenderer/printFileField.md)(array $field) : void
...
Source Code
===========
See the source code for method [HydrogenRenderer::printFileField](https://github.com/lingtalfi/Chloroform_HydrogenRenderer/blob/master/HydrogenRenderer.php#L747-L750)
