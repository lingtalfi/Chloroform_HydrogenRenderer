...
HydrogenRenderer::printRadioField
================



HydrogenRenderer::printRadioField — Prints the given radio field.
...
public [HydrogenRenderer::printRadioField](https://github.com/lingtalfi/Chloroform_HydrogenRenderer/blob/master/doc/api/Ling/Chloroform_HydrogenRenderer/HydrogenRenderer/printRadioField.md)(array $field) : void
...
Source Code
===========
See the source code for method [HydrogenRenderer::printRadioField](https://github.com/lingtalfi/Chloroform_HydrogenRenderer/blob/master/HydrogenRenderer.php#L709-L736)
