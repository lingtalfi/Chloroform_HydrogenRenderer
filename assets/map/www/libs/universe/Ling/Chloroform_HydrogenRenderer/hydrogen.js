...
if (false === ("FormHandler" in window)) {
    (function () {
        ...
        function FormHandler(jForm, fields, options) {
        ...
        FormHandler.prototype.initSummaryLinks = function () {
         ...
         */
        FormHandler.prototype.prepareTimeFields = function () {
         ...
         */
        FormHandler.prototype.compileTimeFields = function () {
            var jField;
        ...
        FormHandler.prototype.getFieldByHtmlName = function (htmlName) {
        ...
        FormHandler.prototype.getValueByField = function (jField) {
         ...
         * @returns {boolean}
         */
        FormHandler.prototype.getFileInfo = function (jField) {
            var file = jField[0];
         ...
         */
        FormHandler.prototype.addFieldErrors = function (id, jField, errors) {
                ...
                if (jSummary.length) {
                    ...
                    if (jSummaryUl.length) {
                        for (var i in tmpErrors) {
                            var jLi = $('<li class="summary-field-error"><a href="#' + id + '">' + tmpErrors[i] + '</a></li>');
            ...
            if (true === this.displayInlineErrors) {
                /**
                 * Note: I search for the .field-label (instead of label) because I know that
                 * the .field-label is nested into a label in which I can
                 * add (css/design wise) error messages.
                 * Meaning this kind of label was designed to nest error messages.
                 *
                 * Not so sure with a regular label.
                 *
                 *
                 */
                ...
                if (jParentField.length) {
                    ...
                    if (jContainer.length) {
                        ...
                        for (var i in tmpErrors) {
                            ...
                            var jSpan = '<span class="field-error"><svg width="1.5em" height="1.5em"><use\n' +
                                '                                    xmlns:xlink="http://www.w3.org/1999/xlink"\n' +
                                '                                    xlink:href="#warning-icon"></use></svg>' + tmpErrors[i] + '\n' +
                                '                    </span>';
                            jContainer.append(jSpan);
                        }
                    } else {
         ...
         */
        FormHandler.prototype.cleanErrors = function () {
            // clean error summary
         ...
         * @param vars
         */
        FormHandler.prototype.getErrorMessage = function (identifier, validator, vars) {
        ...
        FormHandler.prototype.getNonFormattedMessages = function (validator) {
        ...
        FormHandler.prototype.getMinMaxErrorMessage = function (number, validator, errorName, numberKey) {
        ...
        FormHandler.prototype.getMinMaxFileSizeErrorMessage = function (number, validator, errorName, numberKey) {
         ...
         *
         */
        FormHandler.prototype.getPasswordConfirmErrorMessage = function (value, htmlName, validator, errorName) {
            ...
            if (true === otherFieldFound) {
                ...
                if (false !== jField) {
                    ...
                    if (otherFieldValue !== value) {
                        console.log(otherFieldValue + " != " + value);
         ...
         *
         */
        FormHandler.prototype.getPasswordErrorMessage = function (value, validator, errorName) {
        ...
        FormHandler.prototype.error = function (errMsg) {
            throw new Error("Hydrogen FormHandler: " + errMsg);
        };
         ...
         */
        FormHandler.prototype.convertHumanSizeToBytes = function (humanSize) {
            var ret = humanSize;
         ...
         */
        FormHandler.prototype.convertBytes = function (bytes, unit, precision) {
